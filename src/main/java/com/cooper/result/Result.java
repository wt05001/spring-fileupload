...
public class Result<T> {
    ...
    public Result(StatusType statusType, T body) {
        this(statusType.getStatusCode(), statusType.getReasonPhrase(), body);
    }

    public static BodyBuilder status(Status status) {
    ...
    private static class DefaultBuilder implements BodyBuilder {
        ...
        public DefaultBuilder(Status status) {
        ...
        public <T> Result<T> body(T body) {
            return new Result<>(this.statusType, body);
        }
    }
